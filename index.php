...
<html lang="en">
  ...
  ?>
      ...
      <!-- Activity section -->
            <div class="row activity text-center">
                  <div class="col-md act">
                    ...
                    <br>
                    <a href="transfermoney.php"><button style="background-color : #2785C4;">View users</button></a>
                  </div>
                  <div class="col-md act">
      ...
      <footer class="text-center mt-5 py-2">
        <p>&copy 2021. Made by <b>Anjali Sathavara</b> <br> project for <b>The Sparks Foundation</b></p>
      </footer>
